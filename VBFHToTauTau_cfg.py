...
files = FileUtils.loadListFromFile(
    "data/CMS_MonteCarlo2012_Summer12_DR53X_VBF_HToTauTau_M-125_8TeV-powheg-pythia6-tauola-tauPolarOff_AODSIM_PU_S10_START53_V19-v1_00000_file_index.txt"
)
...
process.TFileService = cms.Service(
    "TFileService", fileName=cms.string("VBFHToHToTauTau.root"))
